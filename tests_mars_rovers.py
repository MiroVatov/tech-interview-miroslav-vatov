...
class MarsTests(unittest.TestCase):
    ...
    def test_if_provided_direction_is_not_correct(self):
        self.mars_rover = MarsRover(5, 5, [5, 4, 'B', 'LMLMLMLMM'])
        expected_result = "The direction is not correct!"
        self.assertEqual(expected_result, "The direction is not correct!")

    def test_if_provided_action_is_not_correct(self):
        self.mars_rover = MarsRover(5, 5, [1, 2, 'N', 'AMLMLMLMM'])
        expected_result = "The action provided is not correct!"
        self.assertEqual(expected_result, "The action provided is not correct!")
