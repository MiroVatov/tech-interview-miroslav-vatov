...
mars_rover2 = MarsRover(5, 6, [1, 3, 'N', 'LMLMLMLMM'], [3, 3, 'E', 'MMRMMRMRRM'])
mars_rover2.print_rovers_final_coordinates()
mars_rover3 = MarsRover(5, 7, [6, 2, 'N', 'RMMMLMMLMM'], [3, 3, 'W', 'MMRMMRMRRM'])
mars_rover3.print_rovers_final_coordinates()
mars_rover4 = MarsRover(8, 20, [9, 5, 'S', 'LMLMLMLMM'], [6, 19, 'S', 'MMRMMRMRRM'], [3, 3, 'E', 'MMRMMRMRRM'])
mars_rover4.print_rovers_final_coordinates()
mars_rover = MarsRover(5, 5, [1, 2, 'N', 'LMLMLMLMM'], [3, 3, 'E',])
mars_rover.print_rovers_final_coordinates()
